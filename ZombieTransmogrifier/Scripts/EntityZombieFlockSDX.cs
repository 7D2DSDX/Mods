...
public class EntityZombieFlockSDX : EntityZombieSDX
{
    ...
    public override int DamageEntity(DamageSource _damageSource, int _strength, bool _criticalHit, float _impulseScale)
    {
        ...
        if (blHeadShotsMatter)
        {
            ...
            if (bodyPart == EnumBodyPartHit.Head)
            {
                ...
                _damageSource.DismemberBonus = 0.08f;
            }
        ...
        if (this.AttackTimeout <= 0)
        {
            ...
            if (sqrMagnitude < 1f || sqrMagnitude > 6400f)
            {
                if (!base.isWithinHomeDistanceCurrentPosition() && this.GetMasterEntity() == null && !isHunting)
                {
                    ...
                    Vector3 ye = RandomPositionGenerator.CalcTowards(this, 2 * base.getMaximumHomeDistance(), 2 * base.getMaximumHomeDistance(), base.getHomePosition().position.ToVector3());
                    ...
                    else
                    {
                        if (this.GetMasterEntity() == null)
                        {
                            ...
                            if (FindLandSpot())
                            {
                                ...
                                this.Waypoint = landPosition + new Vector3((float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0));
                            }
                            else
                            {
                                // chooses a random waypoint - vanilla code
                                this.Waypoint = base.GetPosition() + new Vector3((float)((this.rand.NextDouble() * 2.0 - 1.0) * 16.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 16.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 16.0));
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else this.Waypoint = (this.GetMasterEntity() as EntityZombieFlockSDX).GetLandingSpot() + new Vector3((float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0), (float)((this.rand.NextDouble() * 2.0 - 1.0) * 3.0));
                            }
                        }
                    }
                    int num = 255;
            ...
            {
                this.CourseCheck += this.rand.Next(5) + 2;
